...
// FIXME
auto MAX_RPM = 180; // Roughly measured
auto MAX_MAV = MAX_RPM * 2 * PI / 60; // Max motor angular velocity (rad/s)
auto MIN_MAV = -MAX_MAV; // Min motor angular velocity (rad/s)
auto WHEEL_RADIUS = 0.03; // m
auto WHEEL_SEPERATION = 0.1; // m
